...
"
    ...
    exe "amenu <silent> ".MenuIdioms.'.&poj<Tab>\\ipoj                      <Esc>:call C_InsertTemplate("idioms.acm")<CR>'
	exe "vmenu <silent> ".MenuIdioms.'.&poj<Tab>\\ipoj                      <Esc>:call C_InsertTemplate("idioms.acm", "v")<CR>'
	exe "imenu <silent> ".MenuIdioms.'.&poj<Tab>\\ipoj                      <Esc>:call C_InsertTemplate("idioms.acm")<CR>'
...
function! s:CreateAdditionalMaps ()
	...
	noremap    <buffer>  <silent>  <LocalLeader>ipoj        :call C_InsertTemplate("idioms.acm")<CR>
	vnoremap   <buffer>  <silent>  <LocalLeader>ipoj   <Esc>:call C_InsertTemplate("idioms.acm", "v")<CR>
	inoremap   <buffer>  <silent>  <LocalLeader>ipoj   <Esc>:call C_InsertTemplate("idioms.acm")<CR>
